            ...
            <div className='flex gap-3'>
                ...
                <div className='flex-1'>
                    <div className='flex items-center justify-between'>
                        ...
                        <p className='text-xs font-medium text-yellow-700'>{progress}</p>

                    </div>

                    <div className='w-full bg-amber-600 rounded-md h-[5px] relative mt-2'>
                        <div className='bg-amber-400 h-[5px] rounded-md'
